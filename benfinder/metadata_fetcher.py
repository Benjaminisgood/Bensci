...
"""
运行方法：
    python -m benfinder.metadata_fetcher
"""
...
if METADATA_LOG_PATH is not None:
    LOGGER = setup_file_logger("benfinder.metadata_fetcher", METADATA_LOG_PATH)
else:
    LOGGER = logging.getLogger("benfinder.metadata_fetcher")
