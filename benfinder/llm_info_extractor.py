...
from benfinder.config import BLOCKS_OUTPUT_DIR, ENV_FILE, KEYWORD_ALL_TERMS
...
LOGGER = setup_file_logger("benfinder.llm_info_extractor", DEFAULT_LOG_PATH)
...
class LLMExtractionPipeline:
    ...
    def _parse_with_transer(self, path: Path) -> Dict[str, Any]:
        from benfinder.literature_transer import parse_document
